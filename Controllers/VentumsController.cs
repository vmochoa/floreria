...
namespace FloreriaMvc.Controllers
{
    public class VentumsController : Controller
    {
        ...
        public VentumsController(DBFloreriaContext context)
        {
            _context = context;
        }
        ...
        {
            var dBFloreriaContext = _context.Venta.Include(v => v.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("FechaVenta,TotalVenta,ClienteId,VentaId")] Ventum ventum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FechaVenta,TotalVenta,ClienteId,VentaId")] Ventum ventum)
        {
